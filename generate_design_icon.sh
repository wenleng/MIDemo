...
# 创建原始1024x1024图标
# 1. 创建渐变背景
$CONVERT_CMD -size 1024x1024 gradient:"$BLUE_COLOR-$PINK_COLOR" \
...
# 5. 添加文字 "M"(使用白色，代表MIDemo)
$CONVERT_CMD "$ICON_DIR/AppIcon-with-bubble.png" \
    -fill white -font Arial-Bold -pointsize 280 -gravity center \
    -annotate +0+0 "M" \
    "$ICON_DIR/AppIcon-1024.png"

# 清理临时文件
rm "$ICON_DIR/AppIcon-base.png" "$ICON_DIR/AppIcon-rounded.png" "$ICON_DIR/bubble-temp.png" "$ICON_DIR/AppIcon-with-bubble.png"

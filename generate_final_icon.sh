...
# 创建原始1024x1024图标
# 1. 创建渐变背景 - 从上到下的红色渐变
$CONVERT_CMD -size 1024x1024 gradient:'#FF3B30-#FF5E54' \
...
$CONVERT_CMD -size 800x800 xc:none \
    ...
    -draw "circle 400,450 250,450" \
    "$ICON_DIR/bubble1-temp.png"

# 左侧小气泡
$CONVERT_CMD -size 800x800 xc:none \
    -fill white -stroke none \
    -draw "circle 265,375 175,375" \
    "$ICON_DIR/bubble2-temp.png"

# 合并气泡
$CONVERT_CMD "$ICON_DIR/bubble1-temp.png" "$ICON_DIR/bubble2-temp.png" \
...
# 清理临时文件
rm "$ICON_DIR/AppIcon-base.png" "$ICON_DIR/AppIcon-rounded.png" "$ICON_DIR/bubble1-temp.png" "$ICON_DIR/bubble2-temp.png" "$ICON_DIR/bubbles-combined.png" "$ICON_DIR/AppIcon-with-bubbles.png"
